...
public class CircularSlider : SKCanvasView
{
    ...
    public static readonly BindableProperty TrackColorProperty = BindableProperty.Create(nameof(TrackColor),
        typeof(Color), typeof(CircularSlider), Colors.Red, BindingMode.OneWay, null,
        (BindableObject bindable, object oldValue, object newValue) =>
        {
            var instance = (CircularSlider)bindable;
            instance.trackPaint.Color = ((Microsoft.Maui.Graphics.Color)newValue).ToSKColor();
        });
    ...
    public static readonly BindableProperty KnobColorProperty = BindableProperty.Create(nameof(KnobColor),
        ...
        {
            var instance = (CircularSlider)bindable;
            instance.knobPaint.Color = ((Microsoft.Maui.Graphics.Color)newValue).ToSKColor();
        });

    public static readonly BindableProperty TrackProgressColorProperty = BindableProperty.Create(
        nameof(TrackProgressColor),
        typeof(Color), typeof(CircularSlider), Colors.Red, BindingMode.OneWay, null,
        (BindableObject bindable, object oldValue, object newValue) =>
        {
            var instance = (CircularSlider)bindable;
            instance.progressPaint.Color = ((Microsoft.Maui.Graphics.Color)newValue).ToSKColor();
        });
    ...
    public static readonly BindableProperty TrackProgressWidthProperty = BindableProperty.Create(
        nameof(TrackProgressWidth),
    ...
    protected override void OnPaintSurface(SKPaintSurfaceEventArgs e)
    {
        ...
        var arcRect = new SKRect((float)x, (float)y, (float)(x + smallest) - 2 * padding,
            (float)(y + smallest) - 2 * padding);
